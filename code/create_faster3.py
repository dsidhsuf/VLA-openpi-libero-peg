...
def rollout(
    ...
    lift_steps = quality_steps(
        180, train_steps=160, train_insert_faster_steps=85, vla_steps=70, balanced_steps=105, compact_steps=55
    )
    object_axis_align_steps = quality_steps(
        MAX_OBJECT_YAW_ALIGN_STEPS,
        train_steps=320,
        train_insert_faster_steps=110,
        vla_steps=140,
        balanced_steps=220,
        compact_steps=100,
    )
