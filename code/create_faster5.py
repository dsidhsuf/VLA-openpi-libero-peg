...
def rollout(
    ...
    preclose_steps = quality_steps(
        PRECLOSE_STEPS, train_steps=18, train_insert_faster_steps=6, balanced_steps=12, compact_steps=8
    )
    close_gripper_steps = quality_steps(
        CLOSE_GRIPPER_STEPS, train_steps=24, train_insert_faster_steps=6, balanced_steps=14, compact_steps=10
    )
