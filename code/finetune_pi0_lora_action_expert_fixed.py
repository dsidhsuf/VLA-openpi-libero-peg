...
Default behavior:
  ...
  - loads a PI0 base checkpoint through --policy.type=pi0 + --policy.pretrained_path
  - enables LoRA mainly over the PI0 action expert and action/state projection heads
  - keeps the VLM/vision side frozen when train_expert_only=true and freeze_vision_encoder=true
...
DEFAULT_LORA_TARGET_MODULES = (
    r"(.*(?:action_expert|gemma_expert|expert).*(?:q_proj|k_proj|v_proj|"
...
def main():
    ...
    print("lora_scope: action_expert + state/action projection heads")
