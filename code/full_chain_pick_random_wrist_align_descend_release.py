...
def rollout(level: str, seed: int, random_yaw_min_deg: float, random_yaw_max_deg: float, flat_rest_prob: float):
    cfg = LEVEL_CFG[level]
...
def main():
    ...
    rollout(args.level, args.seed, args.random_yaw_min_deg, args.random_yaw_max_deg, args.flat_rest_prob)
