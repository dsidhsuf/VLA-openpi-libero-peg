...
from demo_recorder_fast import DemoRecorder
...
def rollout(level: str, seed: int, random_yaw_min_deg: float, random_yaw_max_deg: float, flat_rest_prob: float, save_demo: bool = False, demo_dir: str = "/root/autodl-tmp/openpi_earbud_proto/demo_examples", camera_size: int = CAMERA_SIZE, save_video: bool = False, demo_image_size: int = 224, demo_compressed: bool = False):
    cfg = LEVEL_CFG[level]
...
def main():
    ...
    parser.add_argument("--demo-image-size", type=int, default=224)
    parser.add_argument("--demo-compressed", action="store_true")
    ...
    rollout(
        ...
        demo_image_size=args.demo_image_size,
        demo_compressed=args.demo_compressed,
    )
