...
# ===== 新增：释放阶段参数 =====
RELEASE_DESCEND_Z = 0.012      # 从 hover 再往下走 1.2 cm
PRE_RELEASE_HOLD_STEPS = 16     # 松开前先稳一下
RELEASE_HOLD_STEPS = 30        # 松开后等待自然下落
RETREAT_Z = 0.08               # 释放后夹爪上抬撤离
