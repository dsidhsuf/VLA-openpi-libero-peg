...
# 扫描更深的下降量（单位：米）
INSERT_DELTA_Z_LIST = [0.010, 0.020, 0.030, 0.040, 0.050, 0.060, 0.070, 0.080, 0.090]
...
def main():
    ...
    out_root = f"/root/autodl-tmp/openpi_earbud_proto/insert_hover_robot_scan_fixed_slot/{ts}"
