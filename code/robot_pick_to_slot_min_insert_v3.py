...
def rollout(level: str):
    ...
    out_dir = f"/root/autodl-tmp/openpi_earbud_proto/robot_pick_to_slot_min_insert_v3/{level}"
    ...
    video_path = os.path.join(out_dir, f"robot_pick_to_slot_min_insert_v3_{ts}.mp4")
