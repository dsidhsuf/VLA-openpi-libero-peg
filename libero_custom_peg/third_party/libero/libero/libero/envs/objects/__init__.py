...
def get_object_dict():
    return OBJECTS_DICT
from .custom_objects import EarbudProtoObject
OBJECTS_DICT["earbud_proto"] = EarbudProtoObject
from .custom_objects import ChargingSlotProtoObject
OBJECTS_DICT["charging_slot_proto"] = ChargingSlotProtoObject
